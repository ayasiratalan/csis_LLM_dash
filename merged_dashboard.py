...
def build_echarts_bar_option(x_data, series_data,
    ...
    option = {
        ...
        "grid": {
            "left": "4%",      
            "right": "5%",
            "bottom": "15%",    # Increased bottom margin to accommodate rotated labels
            "containLabel": True
        },
        "xAxis": {
            "type": "category",
...
def main():
    ...
    st.markdown(
    'for questions <a href="https://www.csis.org/people/yasir-atalan" style="color: #00008B; font-style: italic;">Yasir Atalan</a>',
